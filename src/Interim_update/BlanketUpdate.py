...
def CreateJson(date):
    ...
    with open('../../json_creation/Updated/data-'+date+'.min.json', 'w') as json_file:
...
def ts_json(fileName):
    ...
    with open('../../json_creation/Updated/timeseries.min.json') as fp:
    ...
    for key in data_min.keys():
        ...
        with open('../../json_creation/Updated/timeseries.min.json', 'w') as fp:
...
def ts_state_all(fileName):
    ...
    for key in data_min.keys():
        ...
        with open("../../json_creation/Updated/timeseries-{}.min.json".format(key)) as fp:
                timeseries_min = json.load(fp)
                fp.close()    
        ...
        with open("../../json_creation/Updated/timeseries-{}.min.json".format(key), 'w') as fp:
            json.dump(timeseries_min, fp)
