...
#get_7dma('2021-11-13')
# get_7dma_state('DL', '2022-02-27')
# get_7dma_state('DL', '2022-03-02')
# get_7dma_state('DL', '2022-04-02')
# get_7dma_state('DL', '2022-04-07')
# get_7dma_state('DL', '2022-01-19')
# get_7dma_state('HR', '2022-01-20')
# get_7dma_state('HR', '2022-01-25')
# get_7dma_state('DL', '2022-04-10')

# get_7dma_state('HP', '2022-02-15')
# get_7dma_state('HP', '2022-02-26')
# get_7dma_state('HP', '2022-02-28')
# get_7dma_state('HP', '2022-03-03')
# get_7dma_state('HP', '2022-03-08')
# get_7dma_state('HP', '2022-03-19')
# get_7dma_state('HP', '2022-03-25')
# get_7dma_state('HP', '2022-03-30')
...
# get_7dma_state('BR', '2022-06-22')
# get_7dma_state('KL', '2022-05-27')
# get_7dma_state('PB', '2022-05-20')
# get_7dma_state('MH', '2022-05-29')
# get_7dma_state('KL', '2022-05-31')
# get_7dma_state('MH', '2022-05-08')
# get_7dma_state('MH', '2022-05-15')
# get_7dma_state('MH', '2022-05-22')
# get_7dma_state('MH', '2022-05-29')
# get_7dma_state('UT', '2022-06-06')
# get_7dma_state('KL', '2022-06-13')
# get_7dma_state('AP', '2022-05-05')
# get_7dma_state('KL', '2022-06-23')
# get_7dma_state('HP', '2022-06-26')

# get_7dma_state('KL', '2022-07-09')
# get_7dma_state('KL', '2022-07-10')
# get_7dma_state('PB', '2022-07-24')
# get_7dma_state('TN', '2022-07-07')
# get_7dma_state('HR', '2022-06-29')
# get_7dma_state('RJ', '2022-07-16')
# get_7dma_state('PB', '2022-08-01')
