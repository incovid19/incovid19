...
# ExtractFromHTML(state="KL", date="2021-11-26")
#ExtractFromHTML(state="TR", date="2021-12-01")
# ExtractFromHTML(state="KL", date="2021-11-30")
#ExtractFromHTML(state="MH", date="2021-12-01")
