...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 17 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 17 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 17 + 2)).date()
