...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 19 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 19 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 19 + 2)).date()
