...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 16 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 16 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 16 + 2)).date()
