...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 128 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 128 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 128 + 2)).date()
