...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 138 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 138 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 138 + 2)).date()
