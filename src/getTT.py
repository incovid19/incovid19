...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 21 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 21 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 21 + 2)).date()
