...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 137 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 137 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 137 + 2)).date()
