...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 4 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 4 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 4 + 2)).date()
