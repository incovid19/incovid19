...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 45 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 45 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 45 + 2)).date()
