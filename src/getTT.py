...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 28 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 28 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 28 + 2)).date()
