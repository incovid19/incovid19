...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 141 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 141 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 141 + 2)).date()
