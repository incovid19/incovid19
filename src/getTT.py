...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 126 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 126 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 126 + 2)).date()
