...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 135 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 135 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 135 + 2)).date()
