...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 11 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 11 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 11 + 2)).date()
