...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 13 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 13 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 13 + 2)).date()
