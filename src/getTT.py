...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 26 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 26 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 26 + 2)).date()
