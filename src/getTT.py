...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 18 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 18 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 18 + 2)).date()
