...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 131 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 131 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 131 + 2)).date()
