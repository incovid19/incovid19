...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 70 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 70 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 70 + 2)).date()
