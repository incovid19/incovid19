...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 139 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 139 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 139 + 2)).date()
