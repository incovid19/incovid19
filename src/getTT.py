...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 27 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 27 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 27 + 2)).date()
