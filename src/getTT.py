...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 44 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 44 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 44 + 2)).date()
