...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 136 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 136 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 136 + 2)).date()
