...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 9 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 9 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 9 + 2)).date()
