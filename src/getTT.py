...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 140 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 140 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 140 + 2)).date()
