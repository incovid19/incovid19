...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 15 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 15 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 15 + 2)).date()
