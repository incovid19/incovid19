...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 127 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 127 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 127 + 2)).date()
