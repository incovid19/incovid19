...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 14 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 14 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 14 + 2)).date()
