...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 130 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 130 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 130 + 2)).date()
