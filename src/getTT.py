...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 20 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 20 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 20 + 2)).date()
