...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 129 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 129 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 129 + 2)).date()
