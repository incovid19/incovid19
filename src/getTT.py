...
def getTT():
    today = (datetime.datetime.now() - timedelta.Timedelta(days= 133 + 0)).date()
    pDate = (datetime.datetime.now() - timedelta.Timedelta(days= 133 + 1)).date()
    cowinDate = (datetime.datetime.now() - timedelta.Timedelta(days= 133 + 2)).date()
